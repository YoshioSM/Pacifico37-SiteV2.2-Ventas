...
export default function Footer() {
  const footerNavs = [
    {
      items: [{ href: "/About", name: "About" }],
    },
    {
      items: [
        {
          href: "https://www.linkedin.com/in/yoshio-soto-63a042232",
          name: "Linkedin",
        },
      ],
    },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              Tu oportunidad de vivir frente al océano Pacífico en una de las
              ubicaciones más exclusivas de la costa mexicana. Donde el lujo se
              encuentra con la naturaleza.
            </p>
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">{contactInfo.person}</p>
              </div>
